      ...
      <div className={classes.containerfluid}>
        <div className={classes.container}>
          ...
          <div className={classes.box}>
            <div className={classes.boximg}>{/* <img src={formimg} alt="404" /> */}</div>
            <div className={classes.boxform}>
              <div data-aos="fade-left">
                <form onSubmit={handleSubmit(onSubmit)}>
                  <div className={classes.formp}>
                    <p>Want to know more about the benefits of partnering with Arthmate Direct?</p>
                  </div>
                  ...
                  <div className={classes.forminput}>
                    ...
                    />
                    <hr className={hasError("name") ? classes.errors : classes.errr} />
                    <div className={classes.error}>{errors.name && <p>{errors.name.message}</p>}</div>
                  </div>
                  <div className={classes.forminput}>
                    <Controller
                      name="email"
                    ...
                    />
                    <hr className={hasError("email") ? classes.errors : classes.errr} />
                  ...
                  <div className={classes.forminput}>
                    ...
                    />
                    <hr className={hasError("mobile") ? classes.errors : classes.errr} />
                    <div className={classes.error}>{errors.mobile && <p>{errors.mobile.message}</p>}</div>
                  </div>
                  <div className={classes.btn}>
                    <button type="submit">Submit</button>
                  </div>
                  <span style={{ color: "green" }}>{isSubmitted ? "Request has been sent." : null}</span>
                </form>
              </div>
            </div>
          </div>

            ...
            <div className={classes.appflex}>
              <div data-aos="fade-right">
                <div className={classes.google}>
                  <a href="https://play.google.com/store/apps/details?id=com.arthmatedirect&hl=en_IN" target="_blank">
              ...
              <div data-aos="fade-left">
                <div className={classes.appstore}>
                  <a href="https://apps.apple.com/in/app/arthmate-direct/id6449036566" target="_blank">
